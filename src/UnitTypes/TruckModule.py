# -*- coding: utf-8 -*-
"""
Created on Tue Dec 15 10:27:29 2020
...
class TruckClass(GroundUnitClass):
    """
    The Truck Class
    ...
    def __copy__(self):
        NewUnit = TruckClass(self.ID, self.Owner, self.Health, Position=self.Position, Orientation=self.Orientation)
